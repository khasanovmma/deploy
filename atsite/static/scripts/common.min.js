...
for (var i = 0; i < link.length; i++) {
  link[i].addEventListener("click", function (e) {
    ...
    fetch("".concat(location.origin).concat(get)).then(function (response) {
...
var overflow = document.querySelector('.modal-block__text');
...
var _loop = function _loop(_i3) {
  btn[_i3].addEventListener("click", function () {
    ...
    overflow.style = "max-height: max-content;";
...
span.onclick = function () {
  ...
  html.style.overflow = "auto";
   overflow.style = "max-height: 15px;";
};
...
contactBtn.addEventListener("click", function (e) {
  ...
  if (document.querySelectorAll(".contact__input")[1].value){
  html.style.overflow = "hidden";
...
var load = function load() {
  animate(text1, 0, 258, 5000);
  animate(text2, 0, 10043, 5000);
  animate(text3, 0, 10301, 5000);
}; // nav link
